 ...
 */
final class Version20200621191457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE hazard_statement (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, text LONGTEXT NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pictogram (id INT AUTO_INCREMENT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, type INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, storage_id INT DEFAULT NULL, trash_can_id INT DEFAULT NULL, security_form_name_file VARCHAR(255) DEFAULT NULL, image_name_formula VARCHAR(255) DEFAULT NULL, color_name VARCHAR(255) DEFAULT NULL, french_name VARCHAR(255) NOT NULL, english_name VARCHAR(255) DEFAULT NULL, nomenclature VARCHAR(255) DEFAULT NULL, other_name VARCHAR(255) DEFAULT NULL, cas_number VARCHAR(255) DEFAULT NULL, molar_mass DOUBLE PRECISION DEFAULT NULL, density DOUBLE PRECISION DEFAULT NULL, melting_temperature DOUBLE PRECISION DEFAULT NULL, boiling_temperature DOUBLE PRECISION DEFAULT NULL, optical_index DOUBLE PRECISION DEFAULT NULL, autoflame_temperature DOUBLE PRECISION DEFAULT NULL, risk_of_use LONGTEXT DEFAULT NULL, dangerous_mixtures LONGTEXT DEFAULT NULL, french_commentary LONGTEXT DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_D34A04AD5CC5DB90 (storage_id), INDEX IDX_D34A04ADB3849AC3 (trash_can_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE storage (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trash_can (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', name VARCHAR(255) NOT NULL, family_name VARCHAR(255) NOT NULL, email_address VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, activate TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
